...
static void __stdcall GPU_Dx12DebugCallback(
...
D3D12MessageFunc GPU_GetDx12DebugCallback(void) { return GPU_Dx12DebugCallback; }
...
void GPU_SetDx12ObjDebugName(const GPU_Dx12Instance* renderer, ID3D12Object* obj, utf8str fmtStr, FMT_Args fmtArgs)
{
    ...
    GPU_DX12_CHECKED_CALL(ID3D12Object_SetName(obj, (WCHAR*) wideName.data));
}
