...
"${DP0}/Source/__Brahma/brahma.sh" -package MiseryDependencies -lib_search_dir "${DP0}/Source" -intermediate_output "${DP0}/Intermediate/__Brahma" -out "${DP0}/Source/MiseryDeps/Dependencies" "$@"
